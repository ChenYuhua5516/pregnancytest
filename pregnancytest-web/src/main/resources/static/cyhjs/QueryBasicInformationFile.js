layui.use(['jquery','table','form'], function(){
    ...
    table.render({
        ...
        ,cols: [[
            ...
            ,{field:'midcard', title:'丈夫证件号码', width: 180}
            ,{field:'mbirthdate', title:'丈夫出生日期', width: 120}
            ,{field:'servicetime', title:'建档日期', width: 120}
            ,{field:'asstext', title:'评估状态', width: 90,template:function(d){
                    return d.asstext==null?"未评估":"已评估"

                }}
            ,{field:'checktype', title:'登记类型', width: 90}
